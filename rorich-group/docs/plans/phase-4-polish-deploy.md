...
- Live Vercel URL loads the site correctly
- Custom domain resolves and SSL is active
- Contact form sends email on the live site
- `curl -I https://www.rorichgroup.co.za` shows `content-security-policy` header
